  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <footer className="p-4 bg-gray-800 flex justify-between">
        <button className="bg-green-600 p-2 rounded" onClick={clearChat}>Clear Chat</button>
        {/* <button className="bg-green-600 p-2 rounded">RATE APP</button> */}
        <button className="bg-green-600 p-2 rounded" onClick={handleLogout}>LOG OUT</button>
      </footer>
    </div>
  );
}
